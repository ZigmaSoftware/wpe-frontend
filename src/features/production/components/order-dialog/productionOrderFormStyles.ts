...
export const productionInputClassName =
  "h-11 rounded-xl border-slate-200/90 bg-white text-[15px] text-slate-900 shadow-[0_1px_2px_rgba(15,23,42,0.04)] placeholder:text-slate-300 focus-visible:border-[#2d6cdf] focus-visible:ring-[#2d6cdf]/20";

export const productionCompactInputClassName =
  "h-10 rounded-xl border-slate-200/90 bg-white text-[15px] text-slate-900 shadow-[0_1px_2px_rgba(15,23,42,0.04)] placeholder:text-slate-300 focus-visible:border-[#2d6cdf] focus-visible:ring-[#2d6cdf]/20";

export const productionReadOnlyInputClassName =
  "h-10 rounded-xl border-dashed border-slate-200 bg-slate-50 text-slate-500 placeholder:text-slate-300 shadow-none";
