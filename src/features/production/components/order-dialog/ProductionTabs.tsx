    ...
    {PRODUCTION_ORDER_TABS.map((tab) => {
      ...
      return (
        <TabsTrigger
          ...
          className={cn(
            "relative min-w-fit rounded-none border-b-2 border-transparent px-4 py-3 text-sm font-semibold text-slate-500 shadow-none transition-colors hover:text-slate-800 data-[state=active]:border-[#ff6b00] data-[state=active]:bg-transparent data-[state=active]:text-[#ff6b00] data-[state=active]:shadow-none",
