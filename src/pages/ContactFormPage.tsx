...
const toFormValues = (c: Contact): ContactFormValues => ({
  ...
  contact_code:       (c as any).contact_code        ?? "",
  category:           c.category,
  contact_category:   (c as any).contact_category    ?? "",
  customer_loyalty:   (c as any).customer_loyalty    ?? "",
  company_name:       c.company_name                 ?? "",
  gstin:              c.gstin                        ?? "",
  pan:                (c as any).pan                 ?? "",
  sale_person:        (c as any).sale_person         ?? "",
  division:           (c as any).division            ?? "",
  zone:               (c as any).zone                ?? "",
  subzone:            (c as any).subzone             ?? "",
  tds_category:       (c as any).tds_category        ?? "",
  tds_percent:        String((c as any).tds_percent  ?? ""),
  accounting_percent: String((c as any).accounting_percent ?? ""),
  lead_source:        c.lead_source                  ?? "",
  market_segment:     c.market_segment               ?? "",
  is_active:          c.is_active,
  contact_person:     (c as any).contact_person      ?? "",
  designation:        (c as any).designation         ?? "",
  phone:              c.phone,
  work_phone_2:       (c as any).work_phone_2        ?? "",
  work_phone_3:       (c as any).work_phone_3        ?? "",
  fax:                (c as any).fax                 ?? "",
  email:              c.email                        ?? "",
  address:            c.address,
  billing_landmark:   (c as any).billing_landmark    ?? "",
  billing_city:       (c as any).billing_city        ?? "",
  state:              c.state,
  billing_postal_code:(c as any).billing_postal_code ?? "",
  billing_country:    (c as any).billing_country     ?? "India",
